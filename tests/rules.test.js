...
run('Firestore and Storage trust boundaries', () => {
  ...
  test('friend profiles, codes, limits and relationships are server-only', async () => {
    for (const path of ['bracketPosts/post','bracketPosts/post/comments/comment','bracketPosts/post/likes/alice','socialWriteLimits/alice-posts','accountProfiles/alice','usernames/forged','friendProfiles/alice','friendCodes/ABC','friendRequestLimits/alice','friendships/forged']) {
